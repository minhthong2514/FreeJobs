...
class YoLov5TRT(object):
    def __init__(self, engine_file_path, categories, conf_thresh, iou_thresh):
        # Thiết lập các tham số từ file ngoài truyền vào
        ...
        # Tính toán độ dài dữ liệu segmentation (Giữ nguyên logic file gốc)
    ...
    def infer(self, raw_frames):
        ...
        for i in range(len(raw_frames)):
            ...
            if len(boxes) > 0:
                ...
                self.draw_mask(result_masks, [self.colors_obj(x, True) for x in result_classid], batch_image_raw[i])
